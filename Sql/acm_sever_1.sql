...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 2018-02-24 18:57:25
-- 服务器版本： 5.7.19
-- PHP Version: 5.6.31
...
(10, 1, 1, -9945157, 0, 3, '2018-02-13 23:46:00', 11, 78, 3492, '#include <bits/stdc++.h>\r\nusing namespace std;\r\nconst int N = 1e5+7 , mz = 1e9+7;\r\nint a[N];\r\n\r\nint main(){\r\n    a[1] = a[2] = 1;\r\n    for(int i = 3 ; i < N ; i++)    a[i] = (a[i-1]+a[i-2])%mz;\r\n    int T;\r\n    cin>>T;\r\n    while( T-- ){\r\n        int n;\r\n        cin>>n;\r\n        cout<<a[n]<<endl;\r\n    }\r\n    return 0;\r\n}\r\n', ''),
...
(14, 1, 5, -9945157, 0, 3, '2018-02-23 23:04:27', 7002, 58, 3340, '#include <bits/stdc++.h>\r\nusing namespace std;\r\n\r\nint main(){\r\n    int n;\r\n    scanf(\"%d\",&n);\r\n    char s[200];\r\n    scanf(\"%s\",s + 1);\r\n    int ans = 50;\r\n    for(int i = 1 ; i <= n ; i++){\r\n        if( s[i] == \'c\' ){\r\n            if( s[i+1] == \'w\' ){\r\n                if( s[i+2] == \'w\' ){\r\n                    s[i+1] = s[i+2] = \'a\';\r\n                    ans += 550;\r\n                }else if( s[i-1] == \'w\' ){\r\n                    s[i-1] = s[i+1] = \'a\';\r\n                }else{\r\n                    s[i+1] = \'a\';\r\n                    ans += 400;\r\n                }\r\n            }else{\r\n                ans += 250;\r\n            }\r\n        }\r\n    }\r\n    for(int i = 1 ; i <= n ; i++){\r\n        if( s[i] == \'w\' ){\r\n            ans += 100;\r\n        }\r\n    }\r\n    printf(\"%d\\n\",ans);\r\n    return 0;\r\n}\r\n\r\n', 'main.cpp: In function \'int main()\':\r\r\nmain.cpp:35:17: error: expected \';\' before \'}\' token\r\r\n \r\r\r\n                 ^'),
...
(17, 1, 5, -9945157, 0, 3, '2018-02-23 23:49:11', 11, 140, 3492, '#include <bits/stdc++.h>\r\nusing namespace std;\r\n\r\nint main(){\r\n    int n;\r\n    scanf(\"%d\",&n);\r\n    char s[200];\r\n    scanf(\"%s\",s + 1);\r\n    int ans = 50;\r\n    for(int i = 1 ; i <= n ; i++){\r\n        if( s[i] == \'c\' ){\r\n            if( s[i+1] == \'w\' ){\r\n                if( s[i+2] == \'w\' ){\r\n                    s[i+1] = s[i+2] = \'a\';\r\n                    ans += 550;\r\n                }else if( s[i-1] == \'w\' ){\r\n                    s[i-1] = s[i+1] = \'a\';\r\n                    ans += 535;\r\n                }else{\r\n                    s[i+1] = \'a\';\r\n                    ans += 400;\r\n                }\r\n            }else{\r\n                ans += 250;\r\n            }\r\n        }\r\n    }\r\n    for(int i = 1 ; i <= n ; i++){\r\n        if( s[i] == \'w\' ){\r\n            ans += 100;\r\n        }\r\n    }\r\n    printf(\"%d\\n\",ans);\r\n    return 0;\r\n}\r\n\n', ''),
(18, 1, 5, -9945157, 0, 3, '2018-02-23 23:51:42', 11, 46, 3476, '#include <bits/stdc++.h>\r\nusing namespace std;\r\n\r\nint main(){\r\n    int n;\r\n    scanf(\"%d\",&n);\r\n    char s[200];\r\n    scanf(\"%s\",s + 1);\r\n    int ans = 50;\r\n    for(int i = 1 ; i <= n ; i++){\r\n        if( s[i] == \'c\' ){\r\n            if( s[i+1] == \'w\' ){\r\n                if( s[i+2] == \'w\' ){\r\n                    s[i+1] = s[i+2] = \'a\';\r\n                    ans += 550;\r\n                }else if( s[i-1] == \'w\' ){\r\n                    s[i-1] = s[i+1] = \'a\';\r\n                    ans += 535;\r\n                }else{\r\n                    s[i+1] = \'a\';\r\n                    ans += 400;\r\n                }\r\n            }else{\r\n                ans += 250;\r\n            }\r\n        }\r\n    }\r\n    for(int i = 1 ; i <= n ; i++){\r\n        if( s[i] == \'w\' ){\r\n            ans += 100;\r\n        }\r\n    }\r\n    printf(\"%d\\n\",ans);\r\n    return 0;\r\n}\r\n\n', ''),
(19, 1, 5, -9945157, 0, 3, '2018-02-23 23:53:10', 11, 62, 3492, '#include <bits/stdc++.h>\r\nusing namespace std;\r\n\r\nint main(){\r\n    int n;\r\n    scanf(\"%d\",&n);\r\n    char s[200];\r\n    scanf(\"%s\",s + 1);\r\n    int ans = 50;\r\n    for(int i = 1 ; i <= n ; i++){\r\n        if( s[i] == \'c\' ){\r\n            if( s[i+1] == \'w\' ){\r\n                if( s[i+2] == \'w\' ){\r\n                    s[i+1] = s[i+2] = \'a\';\r\n                    ans += 550;\r\n                }else if( s[i-1] == \'w\' ){\r\n                    s[i-1] = s[i+1] = \'a\';\r\n                    ans += 535;\r\n                }else{\r\n                    s[i+1] = \'a\';\r\n                    ans += 400;\r\n                }\r\n            }else{\r\n                ans += 250;\r\n            }\r\n        }\r\n    }\r\n    for(int i = 1 ; i <= n ; i++){\r\n        if( s[i] == \'w\' ){\r\n            ans += 100;\r\n        }\r\n    }\r\n    printf(\"%d\\n\",ans);\r\n    return 0;\r\n}\r\n\n', ''),
...
(99, 75661895, 56687344, -9945157, '2018-02-24 18:51:00'),
(98, 89677612, 85136820, -9945157, '2018-02-24 15:59:40'),
(97, 59862374, 54223835, -9945157, '2018-02-23 23:53:51'),
...
(1010, '', -9945157, '2017-11-28 15:59:09', '2018-02-24 17:25:12', 9, 1),
...
(10, 1000, 1, 6001, 500, 3488, 1, '2017-12-19 13:35:38', 0, '#include <stdio.h>\r\n\r\nint main(){\r\n    int a,b;\r\n    while(~scanf(\"%d%d\",&a,&b))\r\n        printf(\"%d\\n\",a+b);\r\n    return 0;\r\n}\r\n', ','),
...
(45, 1015, 3, 1, 41, 3332, -9945157, '2018-02-24 15:57:25', 0, '#include <bits/stdc++.h>\r\nusing namespace std;\r\nconst int N = 20 , mz = 1e9+7;\r\nint a[N];\r\ndouble p[N];\r\n\r\nint main(){\r\n    int x,y,z;\r\n    p[0] = 1.0;\r\n    for(int i = 1 ; i <= 12 ; i++){\r\n        scanf(\"%d\",a+i);\r\n        p[i] = p[i-1] / (1.0*a[i]);\r\n    }\r\n    scanf(\"%d%d%d\",&x,&y,&z);\r\n    printf(\"%.9f\\n\",200000.0/(x+1.0)*p[6] + 250000.0/(y+1.0)*p[12] + 50000.0/z/3.0);\r\n    return 0;\r\n}\r\n', '');
