...
input_data = "D:\\test_data\\"
true_output_data = "D:\\test_data\\"
program_info = {
    'take_time': 0,
    'take_memory': 0,
    'result': 7,
...
def run(pro_id):
    ...
    for i in range(data_count):
        # print("i = %d" % i)
        input_data_build = input_data + "%d" % pro_id
        ...
        true_output_data_dir = true_output_data + "%d" % pro_id
        correct_result = os.path.join(output_data, "st.out")
        user_result = os.path.join(true_output_data_dir, "%d.out" % i)
